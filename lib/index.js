...
function init(config) {
  return function () {
    ...
    app.providers.push(function (path, service) {
      ...
      var security = {};
      var properties = Object.keys(doc.definitions[model].properties);
      var orderAndEagerQueries = [];
      properties.forEach(function (prop) {
        if (doc.definitions[model].properties[prop].order) {
          orderAndEagerQueries.push({
      ...
      var eagerProperties = void 0;
      if (doc.definitions[model].eager && doc.definitions[model].eager.allowedEager) {
        eagerProperties = {
          description: '' + doc.definitions[model].eager.allowedEager,
          in: 'query',
          required: false,
          name: '$eager',
          type: 'string'
        };
        orderAndEagerQueries.push(eagerProperties);
      }
      ...
      if (typeof service.find === 'function') {
        pathObj[withoutIdKey].get = utils.operation('find', service, {
          ...
          parameters: [{
            description: 'The resources properties to select',
            in: 'query',
            required: false,
            name: '$select',
            type: 'array',
            ...
            description: 'The limit of resources to find',
            in: 'query',
            required: false,
            name: '$limit',
            type: 'integer'
      ...
      if (typeof service.get === 'function') {
        ...
        if (eagerProperties) {
          parameters.push(eagerProperties);
        }
